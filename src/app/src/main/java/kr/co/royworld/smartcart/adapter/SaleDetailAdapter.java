...
public class SaleDetailAdapter extends BaseAdapter {
    ...
    public SaleDetailAdapter(List<CategorySale> sales) {
        this.sales = sales;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.vi_sale02, parent, false);
        }
        ...
        txtQty.setText(NumberFormat.getInstance(Locale.KOREA).format(sale.getQty())  + "개");
